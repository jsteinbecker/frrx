...
class PreferredHoursGuide(models.Model):
    employee    = models.ForeignKey(Employee, on_delete=models.CASCADE, related_name='preferred_hours_guides',
                                                                        limit_choices_to= { 'fte__lt' : 1 } )
    start_date  = models.DateField()
    hours       = models.PositiveSmallIntegerField(default=0)
    version     = models.ForeignKey('Version', on_delete=models.CASCADE, related_name='preferred_hours_guides',
